...
function applyParallax() {
  ...
  const scrollWrap = document.querySelector(".tpl");
  ...
  document
    .querySelectorAll('.da-item[data-type="section"], .da-item[data-type="image"]')
    .forEach((el) => {
...
document.querySelector(".tpl")?.addEventListener("scroll", applyParallax);
